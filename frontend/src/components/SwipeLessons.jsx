...
export function SwipeLessons({ profile, setFlick, reserveLesson, handleSwipeType, lesson, popularLesson }) {
  ...
  return (
    <>
      ...
      <div>
        ...
        <div>
          <div>
            <center><h1>人気Top3のレッスン</h1></center>
          </div>
          <div className="lesson-box">
            <div className="lesson-details" onClick={() => clickPopularLesson(0)}>
          ...
          <br />
          <div className="lesson-box">
            <div className="lesson-details" onClick={() => clickPopularLesson(1)}>
          ...
          <br />
          <div className="lesson-box">
            <div className="lesson-details" onClick={() => clickPopularLesson(2)}>
